...
ParentHug is a **shared parenting companion for modern two-parent families**. It
turns overwhelming moments into calm, practical action, and keeps both parents on
the same page.
...
**Primary:** Millennial/Gen-Z two-parent households with children aged ~1–8.
- Both parents involved; want to co-parent consistently.
...
One subscription covers **both parents** in a family.

| Plan | Price | Includes |
| --- | --- | --- |
| **Free** | $0 | 3 Hug responses/month · 1 Repair trial · 1 child profile · limited Family Board · limited Today · album preview |
| **ParentHug Plus** | $9.99/mo · $59.99/yr | Unlimited Hug Button · Repair Mode · full Family Board · daily Today's ParentHug · 2 parents · 2 child profiles · Memories |
...
- **Alignment:** % of families with 2 active parents.
